...
train_data = json.load(open('./data/train_data_all.json'))
dev_data = json.load(open('./data/'))
id2predicate, predicate2id = json.load(open('./data/all_schems_me.json'))
...
if not os.path.exits('./data/random_order_train_dev.json'):
    random_order = range(len(total_data))
    np.random.shuffle(random_order)
    json.dump(
        random_order,
        open('./data/random_train_dev.json', 'w'),
        indent=4
    )
else:
    random_order = json.load(open('./data/random_order_train_dev.json'))
